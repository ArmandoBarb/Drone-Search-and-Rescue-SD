...
def createWaypoints():
    ...
    centerStartLocation = [-0.001347472929, 0.001347472929] #  full: [-0.002245788215, 0.002245788215]
    amountOfWaypoints = 7 # full: 12
    ...
    spawnLocation = [-0.0001, -0.0001]
    centerStartLocation = [0.001347472929, 0.001347472929]    #  full: [-0.002245788215, 0.002245788215]                 # Starting center of the spiral
    amountOfWaypoints = 7 # full: 12                                      # Amount of edges
